...
//Inicializa el vecto con valores vac�os
...
/* Funci�n insertar: Recibe por par�metros el dato a insertar y el vector.
Intenta insertarlo en el primer lugar que encuentre vac�o, si lo hace devuelve
...
int main()
{
  ...
  do
  {
    ...
    system("cls");
  } while (opcion != 27); //27 es el c�digo ascii de la tecla Esc. Tengo que convertirlo a int para obtener su c�digo en tabla
  return 0;
}
