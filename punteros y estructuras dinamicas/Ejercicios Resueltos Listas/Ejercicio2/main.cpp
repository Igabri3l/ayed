...
int main()
{
  ...
  getch();
  MostrarLista(lista1);
  cout << "Qu� pasa si se cambia un valor de un nodo de la lista2?" << endl;
  ...
  MostrarLista(lista1);
  getch();
  /*Este m�todo concaten� las listas redireccionando el ultimo puntero
  de la lista 1, como todav�a tenemos el puntero lista2 apuntando al que,
  ...
  MostrarLista(lista2);
  /*Concatenaci�n de listas creando los nodos respectivos */
