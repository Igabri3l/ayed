...
int main()
{
  ...
  p = NULL;
  /* El puntero puede guardar una direcci�n de memoria, por lo tanto la siguiente sentencia es v�lida: */
  p = &n;
  ...
  cout << "La direcci�n de pp es (&pp):" << &pp << endl;
  /* creaci�n de espacio en el heap (memoria din�mica)*/
  p = new int();
  *p = 27;
  ...
  p = NULL;
  /* Aritm�tica de punteros, acceder a un array con punteros */
  ...
  cout << "En la posicion 5 del vector est� el elemento: " << *(p + 5) << endl;
  /* asignaci�n din�mica de memoria */
  alumno* ptr_alumno;
  int cant_alumnos;
  cout << "Cu�ntos alumnos tiene su curso?: " << endl;
  cin >> cant_alumnos;
